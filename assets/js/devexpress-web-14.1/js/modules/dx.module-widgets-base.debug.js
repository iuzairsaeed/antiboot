...
if (!DevExpress.MOD_WIDGETS_BASE) {
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent(SCROLLABLE, ui, DX.DOMComponent.inherit({
            ...
            _elementPosition: function($element, direction) {
                ...
                var isAlreadyVisible = scrollLocation <= elementPosition && elementBottom <= scrollBottom || scrollLocation >= elementPosition && elementBottom >= scrollBottom;
    ...
    (function($, DX, undefined) {
        ...
        $(document).on(events.addNamespace("dxpointerdown", SCROLLABLE_STRATEGY), function(e) {
            pointerDownTime = e.timeStamp || $.now()
        });
        ...
        var offActiveElementChange = function(callback) {
                if (window.addEventListener)
        ...
        ui.dxScrollable.SimulatedStrategy = DX.Class.inherit({
            ...
            _activeElementChangeHandler: function(e) {
                ...
                if (timeStamp - pointerDownTime > FOCUS_TIMEOUT)
    ...
    (function($, DX, undefined) {
        ...
        DX.registerComponent("dxDropDownList", ui, ui.dxDropDownEditor.inherit({
            ...
            _processDataSourceChanging: function() {
                this._setListDataSource();
                this._renderValue().fail($.proxy(this.reset, this))
            },
            reset: function() {
                this.option("value", null);
                this._clearSelectedItem()
    ...
    (function($, DX, undefined) {
        ...
        var views = {MonthView: BaseView.inherit({
                    ...
                    _renderImpl: function() {
                        ...
                        this._$table.off("beforeactivate").on("beforeactivate", function(e) {
                            e.preventDefault()
                        });
