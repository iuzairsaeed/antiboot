...
$SQLGetTicketOwner = $odb -> prepare("SELECT username FROM `users` WHERE `id` = :id LIMIT 1");
$SQLGetTicketOwner -> execute(array(':id' => $senderid));
$OwnerInfo = $SQLGetTicketOwner -> fetch(PDO::FETCH_ASSOC);
$ownerUname = $OwnerInfo['username'];
?>
<!DOCTYPE html>
<html lang="en">
<head>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
						<dl>
							...
							<dt>Ticket Owner:</dt>
							<dd><a href="edituser.php?id=<?php echo $senderid; ?>" target="_blank"><?php echo $ownerUname; ?></a></dd>
						</dl>
                    </div>
                </section>
            </div>
                ...
                <section class="panel">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea rows="6" class="form-control" name="reply" maxlength="4096"></textarea>
							</div>
						</div>
						<div class="form-group">
