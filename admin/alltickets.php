...
<head>
	...
	<title><?php echo $web_title;?>All Tickets</title>
								...
								<section class="panel">
									<div class="panel-body">
										...
										<table id="table-2" class="table table-striped table-bordered" cellspacing="0" width="100%">
											...
											<tbody>
												<?php 
													$GetAnswered = $odb -> prepare("SELECT * FROM `tickets` WHERE `status` = 2 ORDER BY `id` DESC LIMIT 5");
													$GetAnswered -> execute();
								...
								<section class="panel">
									<div class="panel-body">
										...
										<table id="table-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
											...
											<tbody>
												<?php 
													$GetClosed = $odb -> prepare("SELECT * FROM `tickets` WHERE `status` = 3 ORDER BY `id` DESC LIMIT 5");
													$GetClosed -> execute();
